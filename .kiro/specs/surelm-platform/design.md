...
- Tag format: **Feature: surelm-platform, Property {number}: {property_text}**
...
def test_policy_retrieval_relevance(household_data):
    """Feature: surelm-platform, Property 1: Policy Retrieval Relevance"""
...
def test_recommendation_ranking_order(household_data):
    """Feature: surelm-platform, Property 2: Recommendation Ranking Order"""
    recommendations = recommendation_engine.get_recommendations(household_data)
...
def test_offline_sync(actions):
    """Feature: surelm-platform, Property 16: Offline-First Synchronization"""
...
def test_active_policy_filtering(policies, household_data):
    """Feature: surelm-platform, Property 43: Active Policy Filtering"""
