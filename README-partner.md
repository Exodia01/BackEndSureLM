...
1. **Query Embedding**
   - Convert text to 768-dim vector using Ollama embeddings
   - Model: `nomic-embed-text`

2. **Hybrid Search**
   - PostgreSQL FTS for exact terms
...
### Infrastructure:
- PostgreSQL database (PostGIS optional)
- Qdrant vector DB (768-dim vectors)
- Ollama instance for embeddings + LLM
- Node.js 20+ runtime
